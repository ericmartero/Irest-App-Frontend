      ...
      <div className="flex align-items-center justify-content-center h-screen">
        <div className="p-4 w-full lg:w-6 mx-auto">
          <div className="text-center mb-5">
            ...
            <span className="text-600 font-medium line-height-3">Pulsa el botón para reservar a la mesa</span>
          </div>

          <Button type="submit" label={`Reservar la mesa ${props.table?.number}`} className="w-full mt-3" />
        </div>
      </div>
    </div>
  )
